    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', multiselectfield.db.fields.MultiSelectField(choices=[('FE', 'Front-End'), ('BE', 'Back-End'), ('FS', 'Full-Stack'), ('MD', 'Mobile Dev'), ('DO', 'Dev Ops'), ('CS', 'CyberSec.')], max_length=17)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('company_logo', models.ImageField(default='defaultuser.png', upload_to='company_images')),
                ('first_name', models.CharField(max_length=50)),
                ('last_name', models.CharField(max_length=50)),
                ('email', models.EmailField(max_length=254)),
