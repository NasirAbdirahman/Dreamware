# Generated by Django 4.0.4 on 2022-05-04 22:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('interests', multiselectfield.db.fields.MultiSelectField(choices=[('FE', 'Front-End'), ('BE', 'Back-End'), ('FS', 'Full-Stack'), ('MD', 'Mobile Dev'), ('DO', 'Dev Ops'), ('SI', 'Security & Infrastructure')], max_length=17)),
                ...
                ('relocation', models.CharField(choices=[('OK', 'Open To Relocate'), ('NO', 'No')], max_length=2)),
                ('skills', models.ManyToManyField(related_name='CustomUsers', to='dashboard.techskills')),
